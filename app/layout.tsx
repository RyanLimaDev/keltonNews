    ...
    <html className={`h-full + ${inter.className}`} lang="pt-br">
      <body className="h-full">
        <header className="flex items-center justify-center bg-header w-full h-1/6">
          ...
          {children}
        <footer className="flex flex-col bg-header w-full h-1/4 mt-10">
          <div className="w-full h-1/2 flex justify-start items-center pl-4 2xl:pt-8 cursor-pointer">
            <Image alt="Kelton News Assinatura" src={KeltonNewsAssImage} className="w-3/4 sm:w-1/3 lg:w-1/4"/>
          </div>

          <div className="w-full h-1/2 pb-4 flex justify-center lg:justify-between lg:pl-4">
            <div className="flex justify-center lg:justify-start items-end">
              <p className="text-font-white block">© Copyright 2080-2084 Kelton News</p>
            </div>
            <div className="lg:flex justify-start items-end pr-4 w-1/2 hidden">
              <div className="flex justify-evenly items-center w-full text-center lg:text-lg">
